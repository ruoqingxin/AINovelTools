...
export const AI_TASK_PRESETS: AiTaskPreset[] = [
  {
    ...
    tasks: {
      ...
      chapterPlan: { temperature: 0.35, maxOutputTokens: 4096, context: { inputTokenBudget: 28672 } },
      consistencyReview: { temperature: 0.2, maxOutputTokens: 4096, context: { inputTokenBudget: 32768 } },
  ...
  },
  {
    ...
    tasks: {
      ...
      chapterPlan: { temperature: 0.2, maxOutputTokens: 4096, context: { includeProjectKnowledge: true, inputTokenBudget: 32768 } },
      consistencyReview: { temperature: 0.1, maxOutputTokens: 4096, context: { includeProjectKnowledge: true, inputTokenBudget: 36864 } },
  ...
  },
  {
    ...
    tasks: {
      ...
      chapterPlan: { temperature: 0.4, maxOutputTokens: 4096, context: { includeProjectKnowledge: true, inputTokenBudget: 28672 } },
      consistencyReview: { temperature: 0.25, maxOutputTokens: 4096, context: { includeProjectKnowledge: true, inputTokenBudget: 32768 } },
  ...
  },
  {
    ...
    tasks: {
      ...
      chapterPlan: { temperature: 0.25, maxOutputTokens: 4096, context: { includeProjectKnowledge: true, inputTokenBudget: 32768 } },
      consistencyReview: { temperature: 0.15, maxOutputTokens: 4096, context: { includeProjectKnowledge: true, inputTokenBudget: 36864 } },
  ...
  },
  {
    ...
    tasks: {
      ...
      chapterPlan: { temperature: 0.4, maxOutputTokens: 4096, context: { includeProjectKnowledge: true, inputTokenBudget: 28672 } },
      consistencyReview: { temperature: 0.3, maxOutputTokens: 4096, context: { includeProjectKnowledge: true, inputTokenBudget: 32768 } },
  ...
  },
  {
    ...
    tasks: {
      ...
      chapterPlan: { temperature: 0.45, maxOutputTokens: 3072, context: { includeProjectKnowledge: false, inputTokenBudget: 16384 } },
      consistencyReview: { temperature: 0.2, maxOutputTokens: 3072, context: { includeProjectKnowledge: false, inputTokenBudget: 20480 } },
  ...
  },
  {
    ...
    tasks: {
      ...
      chapterPlan: { temperature: 0.3, maxOutputTokens: 5120, context: { includeProjectKnowledge: true, inputTokenBudget: 36864 } },
      consistencyReview: { temperature: 0.15, maxOutputTokens: 5120, context: { includeProjectKnowledge: true, inputTokenBudget: 40960 } },
