...
const classifications: Array<{
...
}> = [
  {
    ...
    label: "任务已取消",
    hint: "需要继续时可重新提交当前任务。",
    patterns: ["cancel", "task_cancelled", "取消"],
  },
  {
    kind: "TIMEOUT",
    label: "请求超时",
    hint: "可直接重试；连续超时时可换更快模型或提高模型超时时间。",
    patterns: ["timeout", "timed out", "provider_timeout", "超时"],
  },
  {
    kind: "RATE_LIMIT",
    label: "服务限流",
    hint: "稍后重试，或为该任务配置备用模型。",
    patterns: ["429", "rate limit", "too many requests", "provider_rate_limited", "限流", "请求过于频繁"],
  },
  {
    kind: "AUTH",
    label: "密钥或权限不可用",
    hint: "重试前请先在“模型 API”中检查密钥、地址和模型权限。",
    patterns: ["401", "403", "unauthorized", "forbidden", "invalid api key", "api key", "provider_authentication", "鉴权", "密钥", "权限"],
  },
  {
    kind: "OUTPUT_TRUNCATED",
    label: "输出预算不足",
    hint: "请在“AI 任务模型”中提高该任务的最大输出后重试；思考内容也会占用同一份预算。",
    patterns: ["达到最大输出", "输出长度", "结束前中断", "返回不完整", "结束标记", "停在半句", "ai_output_length_limit", "ai_output_incomplete", "ai_stream_interrupted"],
  },
  {
    kind: "CONTEXT_LIMIT",
    label: "上下文超出限制",
  ...
  },
  {
    ...
    patterns: ["content policy", "safety", "moderation", "ai_content_filtered", "内容安全", "审核拦截", "敏感"],
  },
  {
    kind: "INVALID_RESPONSE",
    label: "返回内容无法解析",
    hint: "可直接重试；连续失败时可适当降低温度或更换模型。",
    patterns: ["json", "parse", "deserialize", "invalid response", "provider_invalid_response", "解析", "格式错误"],
  },
  {
    kind: "NETWORK",
    label: "网络连接失败",
    hint: "检查网络或模型服务地址后重试。",
    patterns: ["network", "connection", "connect", "dns", "socket", "provider_network", "网络", "连接失败"],
  },
];
