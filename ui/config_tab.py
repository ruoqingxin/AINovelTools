...
def build_ai_config_tab(self):
    ...
    # 5) Temperature
    create_label_with_help(self, self.ai_config_tab, "生成温度:", "temperature", row_start+4, 0)
    ...
    # 6) Max Tokens
    create_label_with_help(self, self.ai_config_tab, "最大输出 Token 数:", "max_tokens", row_start+5, 0)
    ...
    # 7) Timeout
    create_label_with_help(self, self.ai_config_tab, "超时时间（秒）:", "timeout", row_start+6, 0)
...
def build_embeddings_config_tab(self):
    ...
    # 2) Embedding 接口格式
    create_label_with_help(self, parent=self.embeddings_config_tab, label_text="嵌入接口格式:", tooltip_key="embedding_interface_format", row=1, column=0, font=("Microsoft YaHei", 12))
    ...
    create_label_with_help(self, parent=self.embeddings_config_tab, label_text="嵌入服务 Base URL:", tooltip_key="embedding_url", row=2, column=0, font=("Microsoft YaHei", 12))
    ...
    # 5) Retrieval Top-K
    create_label_with_help(self, parent=self.embeddings_config_tab, label_text="检索数量 Top-K:", tooltip_key="embedding_retrieval_k", row=4, column=0, font=("Microsoft YaHei", 12))
